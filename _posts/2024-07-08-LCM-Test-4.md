...
### Sectioning and performing LCM on the POC and POR branches that were prepared on [7/10/24](https://zdellaert.github.io/ZD_Putnam_Lab_Notebook/LCM-Sample-Prep-Further-Tests/), using the same steps outlined in [this early July post](https://zdellaert.github.io/ZD_Putnam_Lab_Notebook/LCM-Test-3/)
