---
layout: post
title: 2026-03-10 Qiagen RNeasy Extraction Tests, Cryosectioned tissue optimization
date: '2026-03-10'
...
- [3/16/26: All final blocks embedded, details in google sheet and notebook](#31626-all-final-blocks-embedded-details-in-google-sheet-and-notebook)
- [Embedded blocks were sectioned 3/17 and 3/19:](#embedded-blocks-were-sectioned-317-and-319)
- [3/25/26: Tissue scrolls extraction](#32526-tissue-scrolls-extraction)
...
Continued testing from first test of this kit for RNA QC [here](https://zdellaert.github.io/ZD_Putnam_Lab_Notebook/Qiagen-RNeasy-Test/) and [here](https://zdellaert.github.io/ZD_Putnam_Lab_Notebook/Qiagen-RNeasy-Test/)
...
12. Add **50 µl RNAse-free** water directly to the spin column membrane. Close the lid gently, and centrifuge for **1 min at 12,000 rcf** to elute the RNA.
13. If higher concentration is desired, re-apply this eluate to the filter membrane and repeat the centrifuge step.
...
<img width="500" alt="2026-03-25" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/tapestation/2026-03-25.png?raw=true">
...
Full results can be found [here](https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/tapestation/2026-03-25.pdf)


| sample_id      | concentration             | RIN | example pic |  slidescan | morphology assessment/notes |
|----------------|---------------------------|-----|----------|----------|----------| 
| Scroll - POC_3 (EDTA 72hr, no sucrose)     |  2.47 ng/uL         | 5.8 | <img width="500" alt="POC_3_2_40x_polyp_tile" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/POC_3_2_40x_polyp_tile.png?raw=true"> | <img width="500" alt="POC_3_2_4x_slideScan_small" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/POC_3_2_4x_slideScan_small.png?raw=true"> | calcioblast morphplogy not preserved as well as POC_4 |
| Scroll - POC_4 (EDTA 72hr, **Sucrose** w/ extra 30% Sucrose:OCT incubation)    |  3.24 ng/uL         | 5.2 | <img width="500" alt="POC_4_2_20x_nice_ring" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/POC_4_2_20x_nice_ring.png?raw=true"> | <img width="500" alt="POC_4_2_4x_slideScan" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/POC_4_2_4x_slideScan.png?raw=true"> | **looks really really great** |
| Scroll - POR_2 (EDTA 72hr, **Sucrose** w/ extra 30% Sucrose:OCT incubation)     |  1.13 ng/uL         | 6.8 | <img width="500" alt="POR_2_2_20X_Section2_4x4bin" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/POR_2_2_20X_Section2_4x4bin.png?raw=true"> | <img width="500" alt="POR_2_2_4X_SlideScan_all_Sep" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/POR_2_2_4X_SlideScan_all_Sep.png?raw=true"> | looks great |
| Scroll - POR_3 (EDTA 96hr, **Sucrose** w/ extra 30% Sucrose:OCT incubation) |  2.18 ng/uL         | 7.8 | <img width="500" alt="POR_3_2_20x_Section6" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/POR_3_2_20x_Section6.png?raw=true"> | <img width="500" alt="POR_3_2_4x_SlideScan" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/POR_3_2_4x_SlideScan.png?raw=true"> | **looks really really great** |
| Scroll - MON_2 (EDTA 48hr, **Sucrose** w/ extra 30% Sucrose:OCT incubation) |  8.22 ng/uL         | 4.9 | <img width="500" alt="MON_2_1_10x_Section4" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/MON_2_1_10x_Section4.png?raw=true"> | <img width="500" alt="MON_2_1_4x_slideScan" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/MON_2_1_4x_slideScan.png?raw=true"> | really jumbled tissue, hard to tell what is what |
| Scroll - MON_3 (EDTA 48hr, **Sucrose** w/o extra 30% Sucrose:OCT incubation) |  7.77 ng/uL         | 4.8 | <img width="500" alt="MON_3_1_10x_section2" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/MON_3_1_10x_section2.png?raw=true"> | <img width="500" alt="MON_3_1_4x" src="https://github.com/zdellaert/ZD_Putnam_Lab_Notebook/blob/master/images/random/scroll_sections/MON_3_1_4x.png?raw=true"> | still not stellar, but maybe the best MON sections we've ever gotten |
